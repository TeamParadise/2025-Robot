...
/**
 * Class to store record-based configs for CTR Electronics Phoenix 6 devices. This includes devices
 * like Talon FX(S), CANcoders, Pigeon 2.0s, and more.
 */
public final class PhoenixDeviceConfigs {
  ...
  public record CANcoderConfig(
      String name, int canId, String canBus, CANcoderConfiguration configuration) {}
  ...
  public record CANrangeConfig(
      String name, int canId, String canBus, CANrangeConfiguration configuration) {}
  ...
  public record PigeonConfig(
      String name, int canId, String canBus, Pigeon2Configuration configuration) {}
  ...
  public record TalonFXConfig(
      String name, int canId, String canBus, TalonFXConfiguration configuration) {}
}
