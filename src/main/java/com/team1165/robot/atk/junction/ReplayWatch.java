...
public class ReplayWatch {
  ...
  public static void main(String[] args) throws IOException, InterruptedException {
    // Find input log
    String inputLog = com.team1165.robot.atk.junction.LogFileUtil.findReplayLogEnvVar();
    if (inputLog == null) {
      inputLog = com.team1165.robot.atk.junction.LogFileUtil.findReplayLogAdvantageScope();
    }
    if (inputLog == null) {
      System.out.println(
          "No input log available for replay watch, please provide with the \""
              + com.team1165.robot.atk.junction.LogFileUtil.environmentVariable
