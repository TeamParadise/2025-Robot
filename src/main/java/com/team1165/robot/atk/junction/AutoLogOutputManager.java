...
import com.team1165.robot.atk.junction.mechanism.LoggedMechanism2d;
    ...
    getAllMethods(root.getClass())
        .forEach(
            (methodAndDeclaringClass) -> {
              ...
              if (method.isAnnotationPresent(com.team1165.robot.atk.junction.AutoLogOutput.class)) {
                ...
                // Get key
                String keyParameter =
                    method.getAnnotation(com.team1165.robot.atk.junction.AutoLogOutput.class).key();
    ...
    getAllFields(root.getClass())
        .forEach(
            (fieldAndDeclaringClass) -> {
              ...
              // If annotated, try to add
              if (field.isAnnotationPresent(com.team1165.robot.atk.junction.AutoLogOutput.class)) {
                // Get key
      ...
      if (type.equals(boolean.class)) {
        callbacks.add(
            () -> {
              ...
              if (value != null)
                com.team1165.robot.atk.junction.Logger.recordOutput(key, (boolean) value);
            });
        ...
        callbacks.add(
            () -> {
              Object value = supplier.get();
              if (value != null)
                com.team1165.robot.atk.junction.Logger.recordOutput(key, (int) value);
            });
        ...
        callbacks.add(
            () -> {
              Object value = supplier.get();
              if (value != null)
                com.team1165.robot.atk.junction.Logger.recordOutput(key, (long) value);
            });
        ...
        callbacks.add(
            () -> {
              Object value = supplier.get();
              if (value != null)
                com.team1165.robot.atk.junction.Logger.recordOutput(key, (float) value);
            });
        ...
        callbacks.add(
            () -> {
              Object value = supplier.get();
              if (value != null)
                com.team1165.robot.atk.junction.Logger.recordOutput(key, (double) value);
            });
        ...
        callbacks.add(
            () -> {
              Object value = supplier.get();
              if (value != null)
                com.team1165.robot.atk.junction.Logger.recordOutput(key, (String) value);
            });
      } else if (type.isEnum()) {
        callbacks.add(
            () -> {
              ...
              if (value != null)
                ...
                com.team1165.robot.atk.junction.Logger.recordOutput(key, ((Enum<?>) value).name());
            });
        ...
        callbacks.add(
            () -> {
              Object value = supplier.get();
              if (value != null)
                com.team1165.robot.atk.junction.Logger.recordOutput(key, (BooleanSupplier) value);
            });
        ...
        callbacks.add(
            () -> {
              Object value = supplier.get();
              if (value != null)
                com.team1165.robot.atk.junction.Logger.recordOutput(key, (IntSupplier) value);
            });
        ...
        callbacks.add(
            () -> {
              Object value = supplier.get();
              if (value != null)
                com.team1165.robot.atk.junction.Logger.recordOutput(key, (LongSupplier) value);
            });
        ...
        callbacks.add(
            () -> {
              Object value = supplier.get();
              if (value != null)
                com.team1165.robot.atk.junction.Logger.recordOutput(key, (DoubleSupplier) value);
            });
        ...
        callbacks.add(
            () -> {
              Object value = supplier.get();
              if (value != null)
                com.team1165.robot.atk.junction.Logger.recordOutput(key, (Measure<?>) value);
            });
        ...
        callbacks.add(
            () -> {
              Object value = supplier.get();
              if (value != null)
                com.team1165.robot.atk.junction.Logger.recordOutput(key, (LoggedMechanism2d) value);
            });
        ...
        callbacks.add(
            () -> {
              Object value = supplier.get();
              if (value != null)
                com.team1165.robot.atk.junction.Logger.recordOutput(key, (Record) value);
            });
      } else {
        callbacks.add(
            () -> {
              ...
              if (value != null)
                try {
                  com.team1165.robot.atk.junction.Logger.recordOutput(key, (WPISerializable) value);
      ...
      if (componentType.equals(byte.class)) {
        callbacks.add(
            () -> {
              Object value = supplier.get();
              if (value != null)
                com.team1165.robot.atk.junction.Logger.recordOutput(key, (byte[]) value);
            });
        ...
        callbacks.add(
            () -> {
              ...
              if (value != null) {
                ...
                com.team1165.robot.atk.junction.Logger.recordOutput(key, names);
              }
            });
