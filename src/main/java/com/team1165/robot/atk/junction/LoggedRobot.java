...
public class LoggedRobot extends IterativeRobotBase {
  ...
  public void startCompetition() {
    ...
    com.team1165.robot.atk.junction.Logger.periodicAfterUser(initEnd, 0);
    ...
    while (true) {
      if (useTiming) {
        ...
        if (nextCycleUs < currentTimeUs) {
          ...
          if (NotifierJNI.waitForNotifierAlarm(notifier) == 0L) {
            ...
            com.team1165.robot.atk.junction.Logger.end();
            break;
          }
        }
      ...
      com.team1165.robot.atk.junction.Logger.periodicBeforeUser();
      long userCodeStart = RobotController.getFPGATime();
      loopFunc();
      long userCodeEnd = RobotController.getFPGATime();

      gcStatsCollector.update();
      com.team1165.robot.atk.junction.Logger.periodicAfterUser(
  ...
  private static final class GcStatsCollector {
    ...
    public void update() {
      ...
      com.team1165.robot.atk.junction.Logger.recordOutput(
          "LoggedRobot/GCTimeMS", (double) accumTime);
