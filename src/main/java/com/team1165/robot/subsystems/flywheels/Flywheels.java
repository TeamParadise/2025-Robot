...
////  private static final LoggedTunableNumber kP = new LoggedTunableNumber("Flywheels/kP",
// gains.kP());
////  private static final LoggedTunableNumber kI = new LoggedTunableNumber("Flywheels/kI",
// gains.kI());
////  private static final LoggedTunableNumber kD = new LoggedTunableNumber("Flywheels/kD",
// gains.kD());
////  private static final LoggedTunableNumber kS = new LoggedTunableNumber("Flywheels/kS",
// gains.kS());
////  private static final LoggedTunableNumber kV = new LoggedTunableNumber("Flywheels/kV",
// gains.kV());
////  private static final LoggedTunableNumber kA = new LoggedTunableNumber("Flywheels/kA",
// gains.kA());
//
//
...
////          "Flywheels/MaxAccelerationRpmPerSec", flywheelConfig.maxAcclerationRpmPerSec());
//
//  private static final double shootingLeftRpm = 5066.0;
...
//        hashCode(), kSVA -> ff = new SimpleMotorFeedforward(kSVA[0], kSVA[1], kSVA[2]), kS, kV,
// kA);
//    LoggedTunableNumber.ifChanged(
//        hashCode(),
//        () -> {
...
//    return startEnd(() -> setGoal(Goal.POOP), () -> setGoal(Goal.IDLE)).withName("Flywheels
// Poop");
//  }
//
// }
