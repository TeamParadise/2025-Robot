...
public class Flywheels extends SubsystemBase {
  ...
  public Command percentCommand(double percent) {
    return startEnd(() -> runPercent(percent), this::stop).withName("Flywheels Basic Percent");
  }

  public Command percentCommands(double leftPercent, double rightPercent) {
    return startEnd(() -> runPercent(leftPercent, rightPercent), this::stop)
